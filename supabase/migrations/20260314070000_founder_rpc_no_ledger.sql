-- =====================================================
-- Patch founder RPCs: remove ledger.events writes
-- (ledger.events schema conflicts with kernel table;
--  object/obligation core logic is fully functional
--  without ledger emission for now)
-- =====================================================
